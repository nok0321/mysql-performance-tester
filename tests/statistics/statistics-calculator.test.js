...
describe('StatisticsCalculator', () => {
    describe('calculate', () => {
        ...
        it('returns null for null input', () => {
            expect(StatisticsCalculator.calculate(null)).toBeNull();
        });
    ...
    describe('round', () => {
        ...
        it('returns null for null/undefined/NaN', () => {
            expect(StatisticsCalculator.round(null, 2)).toBeNull();
            expect(StatisticsCalculator.round(undefined, 2)).toBeNull();
