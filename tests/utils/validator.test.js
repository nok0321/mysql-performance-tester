...
describe('validatePercentile', () => {
    ...
    it('throws for non-number', () => {
        expect(() => validatePercentile('50')).toThrow(ValidationError);
        expect(() => validatePercentile(null)).toThrow(ValidationError);
    });
});
...
describe('validateDatabaseConfig', () => {
    ...
    it('throws for non-object', () => {
        expect(() => validateDatabaseConfig(null)).toThrow(ValidationError);
    });
