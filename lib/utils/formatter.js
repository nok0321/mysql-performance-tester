 ...
 * @param {boolean} [options.verbose=false] - 詳細表示
 * @param {number} [options.decimals=2] - 小数点以下の桁数
 ...
 * @param {Object} [options] - 設定オプション
 * @param {number} [options.decimals=2] - 小数点以下の桁数
 * @param {boolean} [options.includeSymbol=true] - %記号を含める
 * @returns {string} フォーマットされた文字列
 *
 * @example
 ...
 * @param {number} value - 値
 * @param {Object} [options] - 設定オプション
 * @param {number} [options.decimals=0] - 小数点以下の桁数
 * @param {string} [options.separator=','] - 区切り文字
 * @returns {string} フォーマットされた文字列
 *
 * @example
 ...
 * @param {Object} [options] - 設定オプション
 * @param {number} [options.decimals=2] - 小数点以下の桁数
 * @param {boolean} [options.binary=false] - バイナリ単位を使用（1024ベース）
 * @returns {string} フォーマットされた文字列
 *
 * @example
 ...
 */
export function formatQPS(qps, options = {}) {
 ...
 */
export function formatLatency(milliseconds, options = {}) {
    const { decimals = 2 } = options;
 ...
 * @param {Object} [options] - 設定オプション
 * @param {string} [options.format='iso'] - フォーマット形式 ('iso', 'date', 'time', 'datetime')
 * @returns {string} フォーマットされた文字列
 *
 * @example
 ...
 * @param {Object} [options] - 設定オプション
 * @param {Object} [options.formatters] - カラムごとのフォーマッター関数
 * @returns {string} フォーマットされた文字列
 */
...
/**
 * SQLファイル名からテスト名を生成
 * @param {string} filename - ファイル名（例: "01_complex_join.sql"）
 * @returns {string} テスト名（例: "01 Complex Join"）
 *
 * @example
 * generateTestName('01_user_search.sql'); // "01 User Search"
 * generateTestName('検索クエリ.sql');      // "検索クエリ"
 */
export function generateTestName(filename) {
